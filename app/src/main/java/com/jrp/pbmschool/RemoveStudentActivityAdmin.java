    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gradeRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // Update the spinner
                ArrayAdapter<String> adapter = new ArrayAdapter<>(RemoveStudentActivityAdmin.this, android.R.layout.simple_spinner_item, gradeList);
                ...
                myRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for(DataSnapshot child: dataSnapshot.getChildren()){
                            ...
                            if(currentStd && assigned != null && assigned == true && grade.equals(spinner.getSelectedItem().toString())){
