    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gradeRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(AddApproveStudentActivityAdmin.this,android.R.layout.simple_spinner_item, gradeList);
                ...
                myRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for(DataSnapshot child: dataSnapshot.getChildren()){
                            ...
                            if(currentStd && !approved && assigned != null && assigned == true && grade.equals(spinner.getSelectedItem().toString())){
